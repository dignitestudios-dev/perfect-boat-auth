...
const Login = () => {
  ...
  const handleTokenLogin= async()=>{
    try {
      ...
      const response = await axios.post("https://api.theperfectboat.com/auth/signIn/token", obj,{
        headers: {
    ...
    <div className="md:p-0 p-4 w-full h-screen flex items-center justify-center bg-[#001229]">
      {loadingScreen?(
        <div className="flex justify-center items-center mt-10">
          ...
          <p className="text-white text-[22px] opacity-40 text-lg mx-auto">Logging In...</p>
        </div>
      ):(
        <div>
