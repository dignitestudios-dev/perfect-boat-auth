      ...
      <div className="w-full flex flex-col items-center justify-center py-8">
        ...
        {loading ? (
          ...
          <div className="w-auto grid grid-cols-1 justify-center items-center mt-8 gap-6">
            <div
              className="w-full md:w-[420px] xl:w-[440px] h-auto rounded-[20px] xl:rounded-[24px] bg-[#1A293D]
           p-6 md:p-8 flex flex-col gap-6 justify-start items-center"
            >
              <span
             ...
             tracking-[3px] font-normal px-1 md:px-1 text-white rounded-md flex items-center justify-center"
              ...
              <button
                onClick={() => handlePlan(subscriptions[0]?._id)}
                className="outline-none bg-[#55C9FA] text-white rounded-full w-[110px] md:w-[110px] xl:w-[126px] h-[38px] md:h-[40px] xl:h-[44px] flex items-center font-[550] justify-center"
              >
              ...
              <ul className="h-[300px] message-container overflow-auto w-full px-4 md:px-6 xl:px-8 text-[14px] md:text-[16px] text-white font-normal flex flex-col gap-4 justify-start items-start list-disc">
                <li>{subscriptions[0]?.trailDays} free trial days</li>
